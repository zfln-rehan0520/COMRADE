...
class InviteModal(tk.Toplevel):
    def __init__(self, parent):
        ...
        tk.Label(self, text="📡 DISPATCH CHATROOM INVITE", font=("Consolas", 12, "bold"), fg="#38bdf8", bg="#0b1329").pack(pady=(22, 15))
        ...
        self.send_btn = tk.Button(
            self, text="DISPATCH INVITATION", font=("Consolas", 10, "bold"),
            bg="#0284c7", fg="white", activebackground="#0369a1", activeforeground="white",
            relief="flat", cursor="hand2", command=self.start_dispatch,
        )
    ...
    def start_dispatch(self):
        ...
        threading.Thread(target=self._send_in_background, args=(email, room, link), daemon=True).start()
