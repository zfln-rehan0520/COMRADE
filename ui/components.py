...
class PasswordDialog(ctk.CTkToplevel):
    def __init__(self, master, title="Authentication Required", callback=None):
        ...
        self.label = ctk.CTkLabel(self, text="Enter Master Password", font=("Inter", 14, "bold"), text_color="#FFFFFF")
        self.label.pack(pady=(20, 10))

        self.password_entry = ctk.CTkEntry(
            self, show="*", font=("Inter", 13),
        ...
        self.submit_btn = ctk.CTkButton(
            self, text="UNLOCK", font=("Inter", 12, "bold"),
